                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    Container(
                                                        ...
                                                        child: Image.asset("images/hostel1.png",height: 120,width: 120,)),
                                                    SizedBox(width: 20,),
                                                    Image.asset("images/hostel2.png",height: 120,width: 120,),
                                                    SizedBox(width: 10,),
                                                    Image.asset("images/hostel3.png",height: 120,width: 120,),
                                                ...
                                                Center(
                                                  child: Row(
                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                    children: [
                                                      Center(child: Icon(Icons.circle,size: 10,color: Colors.grey,)),
                                                      SizedBox(width: 8,),
                                                      Center(child: Icon(Icons.circle,size: 10,color: Colors.grey,)),
                                                      SizedBox(width: 8,),
                                                      Center(child: Icon(Icons.circle,size: 10,color: Colors.black12,)),
                                                      SizedBox(width: 8,),
                                                      Center(child: Icon(Icons.circle,size: 10,color: Colors.grey,)),
                                                    ],
                                                  ),
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        ...
        crossAxisSpacing: 4.0, // Set spacing between columns
        mainAxisSpacing: 4.0, // Set spacing between rows
      ),
